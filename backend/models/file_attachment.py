...
class FileAttachment(Base):
    ...
    ticket_type = Column(String(50), nullable=False)  # "it", "admin", "transport", "travel", "translator"
    ticket_id = Column(Integer, nullable=False)  # ID of the ticket (IT, Admin, Transport, etc.)
    file_category = Column(String(50), nullable=True)  # For translator: "original" | "translated"
